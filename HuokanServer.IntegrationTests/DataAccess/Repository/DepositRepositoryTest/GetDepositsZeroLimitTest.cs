...
public class GetDepositsZeroLimitTest : DepositRepositoryTestBase
{
	[Fact]
	public async Task TestGetDepositsZeroLimit()
	{
		...
		List<BackedDeposit> deposits = await Repository.GetNewerDeposits(guild.OrganizationId, guild.Id, null, 0);
